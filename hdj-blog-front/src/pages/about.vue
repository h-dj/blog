<template>
  <div class="about">
    ...
    >
      <el-col :span="16">
        <h5 class="title">
          <i class="el-icon-star-on" />{{ $t('about.aboutMe') }}
        </h5>
        <div class="statement">
          <div class="item">
            it技术的探索者
          ...
          <div class="item">
            座右铭：向上的路并不拥挤，而大多数人选择了安逸。
          </div>
        </div>
        <div class="statement">
          <div class="item">
            Email：fengziy@aliyun.com
          </div>
          <div class="item">
            QQ：1224971566
          </div>
        ...
        <h5 class="title">
          <i class="el-icon-star-on" />{{ $t('about.aboutBlog') }}
        </h5>
        ...
        <h5 class="title">
          <i class="el-icon-star-on" />{{ $t('about.contactMe') }}
        </h5>
        <el-card shadow="always">
          <el-form
            label-position="left"
